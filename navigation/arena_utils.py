...
def on_attack_side(pos: Vec2D, team_side: TeamSide, bias=0):
    """
   ...
   :return: bool
   """
    return (pos[0] > (75 - bias) and team_side ==  TeamSide.LEFT) or (pos[0] < (75 + bias) and team_side ==  TeamSide.RIGHT)
...
def on_extended_attack_side(pos: Vec2D, team_side: TeamSide):
    """
    ...
    :return: bool
    """
    return (pos[0] > 55 and team_side ==  TeamSide.LEFT) or (pos[0] < 95 and team_side ==  TeamSide.RIGHT)
...
def univector_pos_section(pos: Vec2D):
    """
    Returns the section of the given object
    :param pos: np.Vec2D([x, y])
    :return: int
    ...
    if pos[0] > MAX_W_SIZE - 10 or pos[0] < 10:
        ...
        if pos[1] < 10:
            return ArenaSections.LEFT_DOWN_CORNER if side == TeamSide.LEFT else ArenaSections.RIGHT_DOWN_CORNER
        elif pos[1] < 45:
            return ArenaSections.LEFT_DOWN_BOTTOM_LINE if side == TeamSide.LEFT else ArenaSections.RIGHT_DOWN_BOTTOM_LINE
        elif pos[1] < 85:
            return ArenaSections.LEFT_GOAL if side == TeamSide.LEFT else ArenaSections.RIGHT_GOAL
        elif pos[1] < 120:
            return ArenaSections.LEFT_UP_BOTTOM_LINE if side == TeamSide.LEFT else ArenaSections.RIGHT_UP_BOTTOM_LINE
        else:
            return ArenaSections.LEFT_UP_CORNER if side == TeamSide.LEFT else ArenaSections.RIGHT_UP_CORNER
...
def goal_position(team_side: TeamSide):
    """
